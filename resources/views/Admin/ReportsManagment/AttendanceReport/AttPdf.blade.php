...
<p> <b>Employee Attendance Report </b> </p>
 ...
 <br> <br>
 <strong>Employee Name : </strong> {{ $allData['0']['UserName']['name'] }}, <strong> ID No : </strong>{{ $allData['0']['UserName']['stu_IdNumber'] }}, <strong> Month : </strong> {{ $month }}
 <br> <br>
<table id="customers">
...
@foreach($allData as $value)
  <tr>    
    <td width="50%"> {{ date('d-m-Y', strtotime($value->attendence_date )) }}  </td>
    <td width="50%"> {{ $value->attendence_status }} </td>
  </tr>
  @endforeach
