...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="date" class="form-control" name="attendence_date" id="attendence_date" required value="{{old('attendence_date')}}">
    </div>
</div>
        </div>
                ...
                @foreach ($employees as $key => $emp)
                    ...
                    <td colspan="3">
                        <div class="switch-toggle switch-3 switch-candy">
                            <input type="radio" name="attendence_status{{$key}}" id="present{{$key}}" value="Present" checked="checked"/>
                            <label for="present{{$key}}">Present</label>
                            <input name="attendence_status{{$key}}" value="Leave" type="radio" id="leave{{$key}}"  >
 <label for="leave{{$key}}">Leave</label>

 <input name="attendence_status{{$key}}" value="Absent"  type="radio" id="absent{{$key}}"  >
