...
<x-box-comp>
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    @foreach ($years as $year)
                        <option value="{{$year->id}}" {{$feeEdit->year_id==$year->id ? 'selected' :''}}>{{$year->year_name}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    @foreach ($classes as $class)
                        <option value="{{$class->id}}" {{$feeEdit->class_id==$class->id ?'selected' :''}}>{{$class->class_name}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    @foreach ($feecategories as $feecat)
                        <option value="{{$feecat->id}}" {{$feeEdit->fee_cate_id==$feecat->id ?'selected' :''}}>{{$feecat->fee_cate_name}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-md-3">
           ...
           <div class="controls">
        <input type="date" name="fee_date" id="fee_date" value="{{$feeEdit->fee_date}}" class="form-control" required> 
         </div>
